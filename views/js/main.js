...
// moved this statement before the for-loop to improve performance
...
function updatePositions() {
  ...
  // moved sin calculations outside the loop to improve performance.
  // var phase = [Math.sin(0), Math.sin(1), Math.sin(2), Math.sin(3), Math.sin(4)];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var numOfPizzas = Math.ceil(screen.height / s) * cols;
